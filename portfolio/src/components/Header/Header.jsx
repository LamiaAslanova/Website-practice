            ...
            <header>
                <div className="header">
                    ...
                    <div className="header__right">
                        ...
                        <div className="top__canva">
                            <button class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop"><i className="fa-solid fa-bars"></i></button>
