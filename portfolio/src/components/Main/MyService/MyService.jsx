        ...
        <>
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="service__title">
                                    <h5>MY SERVICE</h5>
                                    <h2>Crafting stories through <br /> design and innovation</h2>
                                </div>
                            </div>
                        </div>
                        <div className="row" id='service__row'>
                            <div className="col-4 service__col-4">
                            ...
                            <div className="col-6 me__first__col-6">
                                <div className="me__left">
                                    ...
                                    <div className="me__left__text">
                                        ...
                                        <a href="#">Download Cv <i className="fa-solid fa-download"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-6 me__second__col-6">
                                <div className="me__right">
                                    ...
                                    <div className="me__right__text">
                                        <div className="me__right__text__left">
                                            <i class="fa-solid fa-chart-pie"></i>
                                        </div>
                                        <div className="me__right__text__right">
            ...
            <section>
                <div className="design">
                    <div className="container">
                        <div className="row" id='design__row'>
                            <div className="col-6 design__col-6">
                                <div className="design__left">
                                    <div className="design__left__title">
                                        <div className="row">
                                            <div className="col-12">
                                    ...
                                    <div className="design__left__rates">
                                        <div className="row">
                                            <div className="col-6 rate__col-6">
                                                <div className="design__single__rate">
                                                    <span>
